...
public class Camera2VideoFragment extends Fragment
     ...
     */
    private FloatingActionButton mButtonVideo, mButtonSwitch;
        ...
        switch (view.getId()) {
            ...
            case R.id.btnswitch:
                if (!mIsRecordingVideo) {
                    ...
                    Toast.makeText(getActivity(), "Cannot switch while recording.", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private void requestVideoPermissions() {
        if (shouldShowRequestPermissionRationale(VIDEO_PERMISSIONS)) {
            ...
            //this.requestPermissions(this, VIDEO_PERMISSIONS, REQUEST_VIDEO_PERMISSIONS);
